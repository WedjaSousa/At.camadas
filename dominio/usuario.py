...
class Usuario:
    ...
    def __post_init__(self):
        # Se o telefone foi preenchido, aplicamos a regra de negócio
        if self.telefone is not None:
            # Remove espaços, parênteses e traços, mantendo só os números
            apenas_numeros = "".join(c for c in self.telefone if c.isdigit())
            
            # Valida se o comprimento dos números puros está correto
